				...
				<div class="container">
					<div class="row align-items-center pt-1">
							...
							<div class="row row-md">
								...
								<div class="col-12">
									<a href="#" title="">
										...
										<span>Hàng Mỹ</span>
										<a href="#" title=""><img src="images/new.PNG">
										</a>
									</a>
								</div>
								<div class="col-12">
								...
								<!--end col-12-->
								<div class="col-12">
									<a href="#" title="" class="nav-link text-dark">Thông tin hay</a>
									<ul class="nav flex-column">
										<li class="nav-item p-2">
											<a class="text-dark" href="#">
												<i class="fa fa-mobile" aria-hidden="true"></i>
						...
						<div class="col-xl-2 col-lg-2 col-md-2 col-4  pl-1 pr-1">
							<a href="#" title=""><img src="images/fptshop-logo.png" class="img-fluid"></a>
						</div>
						...
						<div class="col-xl-6 col-lg-5 col-md-5 col-12 d-none d-sm-block pl-1 pr-1">
							<ul class="nav justify-content-end">
								<li class="nav-item">
									<a class="nav-link text-center text-white pl-1 pr-1" href="#">
										<i class="fa fa-firefox" aria-hidden="true"></i>
										<br>Hàng Mỹ
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link text-center text-white pl- pr-2" href="#"><i class="fa fa-file-audio-o" aria-hidden="true"></i><br>Thông tin hay</a>
								</li>
								<li class="nav-item">
